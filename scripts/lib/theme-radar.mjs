    ...
    const relatedStocks = [...relatedCodes]
      .map((code) => {
        ...
        return {
          ...
          topSignalTitle: summary.topSignalTitle ?? null,
          topSignalTone: summary.topSignalTone ?? 'normal',
          foreignTargetPrice: summary.foreignTargetPrice ?? null,
          foreignTargetPricePremium: summary.foreignTargetPricePremium ?? null,
